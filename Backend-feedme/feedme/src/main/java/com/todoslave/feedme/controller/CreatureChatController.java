...
public class CreatureChatController {
    ...
    @GetMapping("/creature")
    public ResponseEntity<RagResponseDTO> getCreatureChatData(@RequestParam("ragQuestion")String ragQuestion, @RequestHeader("Authorization") final String accessToken) {
